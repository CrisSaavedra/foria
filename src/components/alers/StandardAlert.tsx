...
const StandardAlert = ({ changeAlertState, alert }: Props) => {
    ...
    return (
        <div className="fixed h-screen flex justify-center items-center w-full left-0">
            <div className="bg-indigo-50 z-10 flex flex-col items-center font-semibold rounded-xl border border-blue-400 max-w-xs">
